                            ...
                            <?php if (isset($payroll) and $payroll != FALSE) {
                                foreach ($payroll as $value) {
                                    echo '<tr>
                                                ...
                                                <td><h3>'.$value->name.'</h3></td>
                                                <td><a href="'.base_url('dashboard/payroll/delete/'.$value->id).'" class="ico del" onclick="return confirm(\' are you sure ?\')" >Delete</a></td>
                                        </tr>';
                                }
                            ...
                            <div class="sort form">
                                <div>
                                    ...
                                    <select name="staff" id="staff" class="field" required="">
                                        ...
                                        <?php if(isset($staff) && $staff!=FALSE){foreach ($staff as $value) {
