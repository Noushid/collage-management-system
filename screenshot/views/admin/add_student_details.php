                        ...
                        <form action="<?php echo base_url('dashboard/students/add/submit') ?>" name="addform" id="addform" method="POST">
                            <div class="sort form">
                                ...
                                <div>
                                    ...
                                    <select name="course" id="course" class="field" required="" >
                                        <option value="" disabled selected >select course</option>
                                        <?php if(isset($course) && $course!=false){ foreach ($course as $value) {
                                            echo '<option value="'.$value->id.'">'.$value->name.'</option>';
                                        } }?>
                                    </select>
                                </div>
                                ...
                                <div>
                                    <label for="gender">Gender</label>
                                <input class="field size5" type="radio" name="gender" value="male" required="">Male
                                    <input class="field size5" type="radio" name="gender" value="female" required="">Female
                                </div>
                                <div>
                                    <label for="father">Father</label>
                                <input class="field size5" type="text" name="father" id="father" required="">
                                </div>
                                <div>
                                    <label for="mother">Mother</label>
                                    <input class="field size5" type="text" name="mother" id="mother" required="">
                                </div>
                                <div>
                                    <label for="pin">Pin code</label>
                                    <input class="field size5" type="text" name="pin" id="pin" required="" >
                                ...
                                <div>
                                    <label for="income">Income</label>
                                    <input class="field size5" type="text" name="income" id="income" required="">
                                </div>
                                <div>
                                    <label for="phone">Phone</label>
                                    <input class="field size5" type="text" name="phone" id="phone" required="">
                                </div>
                                <div>
                                    <label for="mail">Mail</label>
                                    <input class="field size5" type="text" name="mail" id="mail" required="">
                                </div>
                                <div>
                                    <label for="community">Community</label>
                                    <input class="field size5" type="text" name="community" id="community" required="">
                                </div>
                                <div>
                                    <label for="cast">Cast</label>
                                    <input class="field size5" type="text" name="cast" id="cast" required="">
                                </div>
                                <div>
                                    <label for="panchayath">Panchayath</label>
                                    <input class="field size5" type="text" name="panchayath" id="panchayath" required="">
                                </div>
                                <div>
                                    <label for="taluk">taluk</label>
                                     <input class="field size5" type="text" name="taluk" id="taluk" required="">
                                </div>
                                <div>
                                    <label for="district">District</label>
                                     <input class="field size5" type="text" name="district" id="district" required="">
                                </div>
                                <div>
                                    <label for="marital_status">Marital status</label>
    <!--                                 <input class="field size5" type="text" name="martial_status" id="martial_status">-->
                                    <select class="field size5" name="marital_status" id="marital_status" required="" >
                                        <option value="married">married</option>
                                        <option value="un-married">un-married</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="institute">Last studied institute</label>
                                    <input class="field size5" type="text" name="institute" id="institute" required="">
                                </div>
                                <div>
                                    <label for="physical">Physical handicapped</label>
                                    <select class="field size5" name="physical" id="physical" required="">
                                        <option value="yes">yes</option>
                                        <option value="no">no</option>
                                    </select>
                                </div>
